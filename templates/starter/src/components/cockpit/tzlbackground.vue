<template>
  <!-- 台州路文旅驾驶舱背景  样式来源src/style/cockpit.scss文件-->
  <div id="app" class="h100 cockpit-homebg">
    ...
    <div class="home-top flex-between">
      <div class="top_text-box">
        <div class="top_text">“惠”生活驾驶舱</div>
      </div>
...
import map_bg from "@/assets/images/cockpit_images/map-bg-taizhoulu.png"
...
const initMap = () => {
  var imageLayer = new AMap.ImageLayer({
    ...
    bounds: new AMap.Bounds(
      [120.146851,30.324388],
      [120.134593,30.306206]
    ),
    zooms: [8, 26]
  });
